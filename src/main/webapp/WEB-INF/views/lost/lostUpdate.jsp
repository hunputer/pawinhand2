...
<body>
	<form id="frm" action="./lostUpdate" method="post" enctype="multipart/form-data">
    <h3>구분</h3>
    ...
    <div id="lostDate" class="lostDate">
    	<h3>날짜</h3>
    	<input type="date" class="form-control" id="date" name="date" value="${dto.lostDate}">
    </div>
    ...
    <div class="lostLocation">
	    ...
	    <input type="text" name="lostLocation" value="${dto.lostLocation}">
    </div>
    
    <div class="phone">
    	<h3>연락처</h3>
    	<input type="text" value="${dto.phone}" name="phone">
    </div>
    ...
    <div class="color">
      <h3>털색</h3>
      <input type="text" value="${dto.color}" id="color" name="color">
    </div>
    
    <div class="feature">
      <h3>특징</h3>
      <input type="text" value="${dto.feature}" id="feature" name="feature">
    </div>
    
    <div class="contents">
      <h3>상세한 내용</h3>
      <input type="text" value="${dto.contents}" id="contents" name="contents">
    </div>
